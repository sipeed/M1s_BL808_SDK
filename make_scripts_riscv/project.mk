...
COMMON_MAKEFILES := $(abspath $(BL_SDK_PATH)/make_scripts_riscv/project.mk $(BL_SDK_PATH)/make_scripts_riscv/common.mk $(BL_SDK_PATH)/make_scripts_riscv/component_wrapper.mk $(firstword $(MAKEFILE_LIST)))
...
include $(BL_SDK_PATH)/make_scripts_riscv/common.mk
include $(BL_SDK_PATH)/make_scripts_riscv/toolchain.mk
...
info: all
	@cd $(BL_SDK_PATH)/image_conf; env SDK_APP_BIN=$(APP_BIN) SDK_APP_MAP=$(APP_MAP) python3 codesize.py

# If we have `version.mk` then prefer that for extracting BL60x_SP_SDK version
ifeq ("$(wildcard ${BL_SDK_PATH}/version.mk)","")
...
include $(BL_SDK_PATH)/version.mk
...
+$(MAKE) -C $(BUILD_DIR_BASE)/$(2) -f $(BL_SDK_PATH)/make_scripts_riscv/component_wrapper.mk COMPONENT_MAKEFILE=$(1)/bouffalo.mk COMPONENT_NAME=$(2)
endef

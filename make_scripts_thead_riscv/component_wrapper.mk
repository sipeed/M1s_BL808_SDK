...
-include $(BL_SDK_PATH)/make_scripts_thead_riscv/project_val.mk
...
$(subst $(BL_SDK_PATH),$$(BL_SDK_PATH),$(subst $(PROJECT_PATH),$$(PROJECT_PATH),$(subst $(BUILD_DIR_BASE),$$(BUILD_DIR_BASE),$(1))))
endef
...
# ie put literal $(BL_SDK_PATH), $(PROJECT_PATH) and $(BUILD_DIR_BASE) into the generated

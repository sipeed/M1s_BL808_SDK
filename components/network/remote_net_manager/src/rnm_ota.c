...
static void reply_error(rnms_t *rnm, bflb_ota_error_code_t code)
{
    rnm_ota_msg_t msg;
    ...
    msg.status.status_type = BFLB_OTA_ERROR;
...
#define MY_ERROR_OUT(e, r, p) error = e; ret = r; goto p
    ...
    msg.hdr.flags = RNM_MSG_FLAG_ACK;
    msg.msg_type = BFLB_OTA_MSG_STATUS;
    msg.status.status_type = BFLB_OTA_START_ACK;
...
static int handle_abort(rnms_t *rnm, rnm_msg_t *cmd)
{
    ...
    msg.hdr.flags = RNM_MSG_FLAG_ACK;
    msg.msg_type = BFLB_OTA_MSG_STATUS;
    msg.status.status_type = BFLB_OTA_ABORT_ACK;
...
#define MY_ERROR_OUT(e, r, p) error = e; ret = r; goto p
    ...
    ack_msg.hdr.cmd = BF1B_CMD_OTA;
    ack_msg.hdr.flags = RNM_MSG_FLAG_ACK;
    ack_msg.msg_type = BFLB_OTA_MSG_STATUS;
    if (is_last_part) {
...
static int handle_commit(rnms_t *rnm, rnm_msg_t *cmd)
{
    ...
    msg.hdr.flags = RNM_MSG_FLAG_ACK;
    msg.msg_type = BFLB_OTA_MSG_STATUS;
    msg.status.status_type = BFLB_OTA_COMMIT_ACK;

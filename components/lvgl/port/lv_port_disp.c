...
static lv_color_t draw_buf_1[LCD_W * LCD_H / 8]; /*A buffer for 10 rows*/
static lv_color_t draw_buf_2[LCD_W * LCD_H / 8]; /*An other buffer for 10 rows*/
...
#define LVGL_DRAW_BUF1_BASE (0x53100000)
#define LVGL_DRAW_BUF2_BASE (0x53200000)
...
#define LVGL_DRAW_BUF3_BASE (0x53300000)

...
int ili9881c_dsi_vidio_init(ili9881c_dsi_vidio_color_t *screen_buffer)
{
    ...
    DSP2_MISC_SEOF_Set_Source(DSP2_MISC_INT_DISPLAY, DSP2_MISC_SEOF_DISPLAY_TEST_SRC);
    DSP2_MISC_SEOF_Set_Edge(DSP2_MISC_INT_DISPLAY, DSP2_MISC_SEOF_VSYNC_NEGEDGE);
    DSP2_MISC_Int_Callback_Install(DSP2_MISC_INT_DISPLAY, &ili9881c_dsi_frame_interrupt);

...
COMPONENT_PRIV_INCLUDEDIRS := BL808_BSP_Driver/dsp2_reg

COMMON_DVP_DIR := BL808_BSP_Driver/dvp/src/

dvp_sources := $(COMMON_DVP_DIR)ili9488.c \

#               $(COMMON_DVP_DIR)ae_algo.c \
#               $(COMMON_DVP_DIR)awb_algo.c \
#               $(COMMON_DVP_DIR)awb1_algo.c awb2_algo.c \
#               $(COMMON_DVP_DIR)bnr_firmware.c \
#               $(COMMON_DVP_DIR)wdr_firmware.c \
#               $(COMMON_DVP_DIR)img_param.c \
...
COMPONENT_SRCS1 := BL808_BSP_Driver/platform_print/platform_device.c BL808_BSP_Driver/platform_print/platform_gpio.c \
	...
	BSP_Common/lcd/lcd.c \
	BSP_Common/lcd/font.c  \
	BSP_Common/lcd/spi/st7789v_spi.c  \
	...
	BL808_BSP_Driver/StdDriver/Src/bl808_l1c.c	\
	...
	BL808_BSP_Driver/StdDriver/Src/bl808_dvp2axi.c \
